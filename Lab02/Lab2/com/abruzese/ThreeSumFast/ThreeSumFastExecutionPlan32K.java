...
public class ThreeSumFastExecutionPlan32K {
    int[] oneK;
    int[] twoK;
    int[] fourK;
    int[] eightK;
...
//        oneM = new In("1Mints.txt").readAllInts();
    ...
    public int getResult(String benchmarkName){
        return switch (benchmarkName) {
            case "benchThreeSumFast32K" -> benchThreeSumFast32K();
            //case "benchThreeSumFast1M" -> benchThreeSumFast1M();
            default -> 0;
        };
    }
    ...
    public int benchThreeSumFast32K() {
        return ThreeSumFast.count(thirtyTwoK);
    }

//    @Benchmark
//    @BenchmarkMode(Mode.AverageTime)
//    public int benchThreeSumFast1M() {
//        return ThreeSumFast.count(oneM);
//    }
}
